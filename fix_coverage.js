...
// All 66 features from exploratory notes
const ALL_FEATURES = [
    // EXP-INTRO-001
    "Introduction", "Interaction System", "Door / Button Interaction", "Suit Interaction", "Ladder Interaction", "Ship Transition", "Audio Feedback",
    // EXP-INTRO-002
    "Terminal System", "File System", "Authentication Minigame", "Video Playback", "Operations Manual", "UI Interaction", "Power System", "Tutorial Progression",
    // EXP-INTRO-003
    "Camera System", "Map Terminal",
    // EXP-INTRO-004
    "Hallway Doors", "Ship Hallway", "Room Interaction", "Hibernation System", "Cryochamber", "Region Transition",
    // EXP-0B-001
    "Neuros Terminal", "CLI Interface", "Database System", "Paper Interaction", "Filesystem Terminal", "Evaluation.kp4 Minigame", "Red/Green Face Detection", "Hibernation",
    // EXP-1-001
    "Hallway Lighting Sequence", "SAFETY.a Training Video", "Planet Scanning", "Cerebellum Discovery", "Timing Minigame", "Report Generation", "Map System", "Course Setting", "Prerequisite Blocking", "Camera Counter",
    // EXP-2-001
    "Hallway Lighting Effects", "Secret Discovery", "LAD.r File", "Raspberry Stamp", "Ladagocia Discovery", "Map Progression", "Door Interaction", "Light Culling",
    // EXP-3-001
    "Minigame Completion", "Camera Repair System", "Region 3 Progression", "File System Archiving", "End-Game Portal",
    // EXP-GENE-001
    "Control Onboarding", "Environmental Interaction", "Visual Rendering", "Ladder Transition", "Ship Control System", "Screen Interaction", "Progression Logic", "Door System", "Collision Handling", "Audio Settings", "UI Settings Persistence", "Language Localization"
];

// Mapping of test case patterns to features
const featureMapping = {
    ...
    // Confirmation tests - these cover defect confirmations
        ...
        if (fs.statSync(fullPath).isDirectory()) {
            ...
            try {
                ...
                if (featureMapping[tcId]) {
                    ...
                    updatedCount++;
                } else if (!content.derivedFeature) {
                    console.log(`WARNING: No mapping for ${tcId}`);
                }
            } catch (e) {
